    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (e.getSource() == this.view.getBtnAgregar()){
            ...
            if (modelo.agregarLibro(libro)){
                JOptionPane.showConfirmDialog(view, "Se agrego correctamente", "Aviso", JOptionPane.INFORMATION_MESSAGE);
                this.view.getTblLibro().updateUI();
            }else {
                JOptionPane.showConfirmDialog(view,"No se puede agregar, porfavor revise su conexion","Error al insertar", JOptionPane.ERROR_MESSAGE);
            }
        }
        this.view.limpiar();
    }
